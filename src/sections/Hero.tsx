...
export const Hero = () => {
  ...
  return (
    <section ref={heroRef} className="pt-8 px-5 pb-20 md:pt-5 md:pb-10  bg-[radial-gradient(ellipse_200%_100%_at_bottom_left,#183EC2,#EAEEFE_100%)] overflow-x-clip">
      <div className="container mx-auto">
        <div className="md:flex w-full items-center md:justify-between">
          <div className="md:flex-[1.2] max-w-xl">
            ...
            <p className="text-xl text-[#010D3E] tracking-tight mt-6 ">Celebrate the joy of accomplishment with an app designed to 
              track your progress, motivate your efforts, and celebrate your success.</p>
          ...
          <div className="mt-20 md:mt-0 md:flex-[1.5] relative md:h-[648px]">
            <motion.img 
              src={cogImage.src}
              alt="Cog Image"
